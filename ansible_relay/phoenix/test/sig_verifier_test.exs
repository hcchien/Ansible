defmodule AnsibleRelay.SigVerifierTest do
  ...
  test "verifies hardware-compatible P-256 SHA-256 signatures" do
    {public_key, private_key} = :crypto.generate_key(:ecdh, :secp256r1)
    message = "hardware-registration-nonce"
    ...
    refute SigVerifier.verify_identity(
             "p256-sha256",
             Base.encode16(public_key, case: :lower),
             message <> "tampered",
             Base.encode16(signature, case: :lower)
