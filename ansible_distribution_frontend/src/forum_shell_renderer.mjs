...
function renderAppFooter(viewModel) {
  ...
  return `
    <footer class="app-footer">
      ...
      <span><a href="#/about">${escapeHtml(t('common.aboutElix'))}</a> · <a href="${escapeAttribute(legalHref('/privacy'))}">${escapeHtml(t('common.privacyPolicy'))}</a> · <a href="${escapeAttribute(legalHref('/terms'))}">${escapeHtml(t('common.termsOfService'))}</a></span>
