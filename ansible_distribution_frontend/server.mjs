...
const APPVIEW_PROXY_PATH = /^\/api\/v1\/(content\/(?:murmur|note)\/[^/]+|boards\/[^/]+\/external|board-feed|thread\/[^/]+|profiles\/[^/]+|timeline|home|suggest\/follows|explore|search|search\/actors)$/;
