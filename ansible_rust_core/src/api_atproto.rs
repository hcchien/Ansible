...
pub fn api_cbor_encode_record(record: LexiconRecord) -> Vec<u8> {
...
#[frb(sync)]
pub fn api_create_did_plc(signing_key_hex: String, handle: String, pds_endpoint: String) -> PlcGenesisOp {
