defmodule AnsibleAppview.Web.Plugs.RequireProtocolVersion do
  @moduledoc """
  Enforces the AppView's minimum supported protocol version on `/api/*`
  routes. Mirrors `AnsibleRelay.Web.Plugs.RequireProtocolVersion`.
